...
public class Calculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        viewWindow = new javax.swing.JTextField();
        ...
        viewWindow.setFont(new java.awt.Font("Consolas", 0, 18)); // NOI18N
        viewWindow.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        viewWindow.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                viewWindowActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(viewWindow, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        String ans;
        secondNum = Double.parseDouble(viewWindow.getText());
        if (operation == "+") {
            results = firstNum + secondNum;
            ans = String.format("%.Of", results);
            viewWindow.setText(ans);
        } else if (operation == "-") {
            results = firstNum - secondNum;
            ans = String.format("%.Of", results);
            viewWindow.setText(ans);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String EnterNum = viewWindow.getText() + jButton2.getText();
        viewWindow.setText(EnterNum);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        String EnterNum = viewWindow.getText() + jButton4.getText();
        viewWindow.setText(EnterNum);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String EnterNum = viewWindow.getText() + jButton1.getText();
        viewWindow.setText(EnterNum);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        String EnterNum = viewWindow.getText() + jButton16.getText();
        viewWindow.setText(EnterNum);
    }//GEN-LAST:event_jButton16ActionPerformed

    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        String EnterNum = viewWindow.getText() + jButton17.getText();
        viewWindow.setText(EnterNum);
    }//GEN-LAST:event_jButton17ActionPerformed

    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        String EnterNum = viewWindow.getText() + jButton15.getText();
        viewWindow.setText(EnterNum);
    }//GEN-LAST:event_jButton15ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        String EnterNum = viewWindow.getText() + jButton5.getText();
        viewWindow.setText(EnterNum);
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        String EnterNum = viewWindow.getText() + jButton6.getText();
        viewWindow.setText(EnterNum);
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        String EnterNum = viewWindow.getText() + jButton10.getText();
        viewWindow.setText(EnterNum);
    }//GEN-LAST:event_jButton10ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        String EnterNum = viewWindow.getText() + jButton7.getText();
        viewWindow.setText(EnterNum);
    }//GEN-LAST:event_jButton7ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        firstNum = Double.parseDouble(viewWindow.getText());
        viewWindow.setText("");
        operation = "+";
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        double ops = Double.parseDouble(String.valueOf(viewWindow.getText()));
        ops = ops * (-1);
        viewWindow.setText(String.valueOf(ops));
    ...
    private void viewWindowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewWindowActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_viewWindowActionPerformed
    ...
    private javax.swing.JTextField viewWindow;
